...
from personal_agent.persistence.models import Base, Conversation, Memory, User
...
class TestRAGPipeline(unittest.TestCase):
    ...
    def test_rag_handles_no_memories_gracefully(self) -> None:
        ...
        self.mock_gateway.generate = MagicMock(return_value="I don't have enough context!")
    ...
    def test_rag_includes_memory_citations_when_requested(self) -> None:
        ...
        self.mock_gateway.generate = MagicMock(return_value="You should focus on API design.")
