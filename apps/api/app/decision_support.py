...
{{
  ...
  "reversibility_note": "How to undo if this doesn't work out"
        ...
        # Decision reasoning uses gateway directly — memory retrieval is handled
        # by the Agent via RetrievalPipeline before invoking decision. RAG is not
        # used here to keep a single retrieval path (M6.10.1).
