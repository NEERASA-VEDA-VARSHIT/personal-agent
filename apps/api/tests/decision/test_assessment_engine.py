...
from app.decision.engine import AssessmentEngine, Evidence, EvidenceAnalysis, ImpactLevel, Reversibility, StakesAssessment, Stake
from app.decision.models import Assessment, DecisionAssessment, EvidenceStrength
...
class TestAssessmentEngine(unittest.TestCase):
    ...
    def test_legacy_engine_still_works(self) -> None:
        ...
        from app.decision.engine import DecisionRecommender
